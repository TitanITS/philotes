  ...
  Widget build(BuildContext context) {
    ...
    final otherInterests =
        profile.selectedInterests
            .where(
              (interest) =>
                  !profile.favoriteInterests.contains(
                    interest,
                  ),
            )
            .toList();
              ...
              child: Column(
                ...
                children: [
                  ...
                  _ReviewCard(
                    ...
                    child:
                        profile.favoriteInterests.isEmpty
                            ? const Text(
