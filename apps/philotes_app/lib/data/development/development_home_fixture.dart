class DevelopmentHomeFixture {
  const DevelopmentHomeFixture._();

  static const bool hasPlanToday = false;

  static const String todayPlanTitle = 'Bowling with Robert and Michael';

  static const String todayPlanTime = '7:00 PM';

  static const int unreadConversations = 2;

  static const int newConnections = 1;

  static const String outingFriendName = 'Jordan';

  static const String outingActivity = 'Axe Throwing';
