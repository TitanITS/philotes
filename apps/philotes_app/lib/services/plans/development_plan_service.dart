...
class DevelopmentPlanService extends PlanService {
  const DevelopmentPlanService();

  static const List<PhilotesPlan> _developmentPlans = <PhilotesPlan>[
    PhilotesPlan(
      id: 'dev-axe-throwing',
      title: 'Axe Throwing',
      dateLabel: 'Today',
      timeLabel: '7:00 PM',
      locationName: 'Bull City Axe Throwing',
      locationArea: 'Durham, NC',
      attendees: <String>['Alex', 'Jordan', 'Taylor'],
      notes:
    ...
    PhilotesPlan(
      ...
      timeLabel: '7:00 PM',
      locationName: 'Triangle Bowling Center',
      locationArea: 'Durham, NC',
      attendees: <String>['Alex', 'Jordan', 'Taylor', 'Morgan'],
      notes:
          'Two lanes are planned. '
          'Arrive a few minutes early '
          'if you need bowling shoes.',
      status: PhilotesPlanStatus.upcoming,
      isOrganizer: true,
    ),
    PhilotesPlan(
      id: 'dev-hockey-game',
      ...
      timeLabel: '7:30 PM',
      locationName: 'Lenovo Center',
      locationArea: 'Raleigh, NC',
      attendees: <String>['Alex', 'Jordan', 'Morgan'],
      notes:
    ...
    PhilotesPlan(
      ...
      timeLabel: '1:00 PM',
      locationName: 'North Carolina Museum of Art',
      locationArea: 'Raleigh, NC',
      attendees: <String>['Alex', 'Casey'],
      notes:
    ...
    PhilotesPlan(
      ...
      dateLabel: 'August 7',
      timeLabel: '6:30 PM',
      locationName: 'Downtown Durham',
      locationArea: 'Durham, NC',
      attendees: <String>['Alex', 'Jordan', 'Taylor'],
      notes: 'A relaxed dinner after work.',
    ...
    PhilotesPlan(
      ...
      dateLabel: 'August 2',
      timeLabel: '7:15 PM',
      locationName: 'Local Cinema',
      locationArea: 'Durham, NC',
      attendees: <String>['Alex', 'Taylor'],
      notes:
  ...
  PhilotesPlan? planById(String planId) {
    for (final plan in _developmentPlans) {
      if (plan.id == planId) {
        return plan;
      }
    }
