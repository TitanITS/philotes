...
void main() {
  ...
  testWidgets(
    'Messages opens from main navigation',
    (
      WidgetTester tester,
    ) async {
  ...
  testWidgets(
    'Unread conversations are emphasized',
    (
      WidgetTester tester,
    ) async {
      await openMessages(tester);
  ...
  testWidgets(
    'Unread badge clears immediately when thread opens',
    (
      WidgetTester tester,
    ) async {
      await openMessages(tester);
  ...
  testWidgets(
    'Message can be composed locally',
    (
      WidgetTester tester,
    ) async {
      await openMessages(tester);
  ...
  testWidgets(
    'Create Message opens friend selector',
    (
      WidgetTester tester,
    ) async {
      await openMessages(tester);
  ...
  testWidgets(
    'Multiple friends create group mode',
    (
      WidgetTester tester,
    ) async {
      await openMessages(tester);
      ...
      await tester.tap(
        find.byKey(
          const Key(
            'messageFriendChoice-dev-jordan',
          ),
        ),
      );
      ...
      await tester.tap(
        find.byKey(
          const Key(
            'messageFriendChoice-dev-taylor',
          ),
        ),
      );
  ...
  testWidgets(
    'Direct message cannot add participants',
    (
      WidgetTester tester,
    ) async {
      await openMessages(tester);
  ...
  testWidgets(
    'Home unread conversations opens Messages',
    (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
  ...
  testWidgets(
    ...
    (
      ...
      final markReadButton = find.byKey(
        const Key(
          'bulkMarkReadButton',
        ),
      );
      ...
      final markUnreadButton = find.byKey(
        const Key(
